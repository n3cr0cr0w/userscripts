// ==UserScript==
// @name         DisneyPlus Skips
// @namespace    https://github.com/N3Cr0Cr0W/userscripts
// @version      0.1
// @description  Skips Recap, Intro and Ads. Allows Saved PlaybackRate.
// @author       N3Cr0Cr0W
// @downloadURL  https://raw.githubusercontent.com/N3Cr0Cr0W/userscripts/master/DisneyPlus.Skips.user.js
...
(function(){
	...
	function skipsAndStuff(){
		var playbackRate=GM_getValue('playbackRate',1);
		var recap=document.evaluate('//span[text()="SKIP RECAP"]',document,null,9,null).singleNodeValue;
		var intro=document.evaluate('//span[text()="SKIP INTRO"]',document,null,9,null).singleNodeValue;
